...
const ORB_V25_STYLE = String.raw`
/* TALERA ORB v25 — fixed clean SVG cloud test. Directly on worker.js. */
.core-wrap{
...
.core,.core.active,.core.listening{
  ...
  animation:taleraOrb25Pulse 6.0s ease-in-out infinite!important;
}
...
.orb-v25-light,
.orb-v25-cloud-deep,
.orb-v25-cloud-white-a,
.orb-v25-cloud-white-b,
.orb-v25-wisp{
  transform-box:fill-box;
  transform-origin:center;
  will-change:transform,opacity;
}
.orb-v25-light{animation:taleraOrb25Light 7.4s ease-in-out infinite}
.orb-v25-cloud-deep{animation:taleraOrb25Deep 9.6s ease-in-out infinite alternate}
.orb-v25-cloud-white-a{animation:taleraOrb25CloudA 8.2s cubic-bezier(.45,.05,.40,.96) infinite alternate}
.orb-v25-cloud-white-b{animation:taleraOrb25CloudB 6.7s cubic-bezier(.45,.05,.40,.96) infinite alternate}
.orb-v25-wisp{animation:taleraOrb25Wisp 5.2s ease-in-out infinite alternate}
.core.active .orb-v25-light,.core.listening .orb-v25-light{animation-duration:5.0s}
.core.active .orb-v25-cloud-deep,.core.listening .orb-v25-cloud-deep{animation-duration:6.4s}
.core.active .orb-v25-cloud-white-a,.core.listening .orb-v25-cloud-white-a{animation-duration:5.4s}
.core.active .orb-v25-cloud-white-b,.core.listening .orb-v25-cloud-white-b{animation-duration:4.4s}
.core.active .orb-v25-wisp,.core.listening .orb-v25-wisp{animation-duration:3.6s}
...
const ORB_V25_SVG = String.raw`<svg class="orb-v25-svg" viewBox="0 0 200 200" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <clipPath id="orb25Clip"><circle cx="100" cy="100" r="100"/></clipPath>

    <radialGradient id="orb25Base" cx="32%" cy="25%" r="86%">
    ...
    <radialGradient id="orb25LightField" cx="50%" cy="50%" r="50%">
    ...
    <filter id="orb25CloudWhite" x="-38%" y="-38%" width="176%" height="176%" color-interpolation-filters="sRGB">
    ...
    <filter id="orb25CloudWhiteFine" x="-38%" y="-38%" width="176%" height="176%" color-interpolation-filters="sRGB">
    ...
    <filter id="orb25CloudBlue" x="-38%" y="-38%" width="176%" height="176%" color-interpolation-filters="sRGB">
    ...
    <filter id="orb25Wisp" x="-40%" y="-40%" width="180%" height="180%" color-interpolation-filters="sRGB">
  ...
  <g clip-path="url(#orb25Clip)">
    <circle cx="100" cy="100" r="101" fill="url(#orb25Base)"/>

    <g class="orb-v25-light">
      <ellipse cx="85" cy="79" rx="47" ry="42" fill="url(#orb25LightField)"/>
      <ellipse cx="137" cy="126" rx="35" ry="31" fill="url(#orb25LightField)" opacity=".46"/>
    </g>

    <g class="orb-v25-cloud-deep">
      <rect x="-32" y="-32" width="264" height="264" filter="url(#orb25CloudBlue)"/>
    </g>

    <g class="orb-v25-cloud-white-a">
      <rect x="-34" y="-34" width="268" height="268" filter="url(#orb25CloudWhite)"/>
    </g>

    <g class="orb-v25-cloud-white-b">
      <rect x="-38" y="-38" width="276" height="276" filter="url(#orb25CloudWhiteFine)"/>
    </g>

    <g class="orb-v25-wisp">
      <rect x="-40" y="-40" width="280" height="280" filter="url(#orb25Wisp)"/>
    </g>
  </g>
</svg>`;

function enhance(html){
  const mountScript = '<script>(function(){var svg='+JSON.stringify(ORB_V25_SVG)+';function mount(){document.querySelectorAll(".core").forEach(function(core){if(core.getAttribute("data-orb-v25")==="1")return;core.setAttribute("data-orb-v25","1");core.innerHTML=svg;});}mount();var root=document.getElementById("app")||document.body;new MutationObserver(mount).observe(root,{childList:true,subtree:true});})();</scr'+'ipt>';
  return html
    .replace('</head>','<style>'+ORB_V25_STYLE+'</style></head>')
...
export default {
  async fetch(request,env,ctx){
    ...
    headers.set('x-talera-orb-app','organic-v25-fixed-svg-clearings-motion');
