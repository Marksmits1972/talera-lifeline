...
const TALERA_DEPLOY_REV = "workblad-v2-voice-first-listen-chain-20260911";
...
function enhanceWorkblad(html){
  return html
    ...
    .replace('</body>',WORKBLAD_NEW_STORY_CONTEXT_SCRIPT+WORKBLAD_V2_SCRIPT+WORKBLAD_UNIVERSAL_NAV_SCRIPT+WORKBLAD_LAYOUT_TUNING_SCRIPT+WORKBLAD_AUDIO_PERSIST_SCRIPT+WORKBLAD_PHOTO_SWIPE_LITE_SCRIPT+WORKBLAD_REQUIRED_DATE_SCRIPT+WORKBLAD_DIRECT_OPEN_GUARD_SCRIPT+WORKBLAD_VOICE_FIRST_SCRIPT+'</body>');
}
