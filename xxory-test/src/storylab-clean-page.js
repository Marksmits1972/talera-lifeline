...
(function(){
  ...
  document.getElementById('moreBtn').onclick=()=>openModal('moreModal');document.getElementById('editBtn').onclick=()=>{closeModal('moreModal');document.getElementById('editTitle').value=title.value;document.getElementById('editDate').value=dateInput.value;openModal('editModal')};document.getElementById('noteBtn').onclick=()=>{closeModal('moreModal');document.getElementById('noteText').value=state.note||'';openModal('noteModal')};document.getElementById('fitBtn').onclick=async()=>{state.fit=state.fit==='contain'?'cover':'contain';bg.style.objectFit=state.fit;await saveState();closeModal('moreModal')};document.getElementById('removeBtn').onclick=removeCurrent;
