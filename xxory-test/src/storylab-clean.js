...
const STORYLAB_CLEAN_UX_REVISION = 'storylab-clean-ux-20260922-r19';
...
const UX_STYLE = `<style id="talera-storylab-clean-ux-r19">
...
const EARLY_SESSION_SCRIPT = `<script id="talera-storylab-clean-fresh-session-r19">
(()=>{
...
const LATE_UX_SCRIPT = `<script id="talera-storylab-clean-late-ux-r19">
(()=>{
