...
(() => {
  ...
  function ensureStyle(){
    ...
    style.textContent='.talera-story-manage-bar{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin:0 0 2px}.talera-story-manage-button{min-height:48px;border:0;border-radius:16px;padding:0 12px;font:760 13px/1.15 -apple-system,BlinkMacSystemFont,system-ui,sans-serif}.talera-story-manage-photos{color:#0F2747;background:rgba(220,234,246,.72);box-shadow:inset 0 0 0 1px rgba(15,39,71,.08)}.talera-story-manage-delete{color:#8A2F2A;background:rgba(193,79,69,.10);box-shadow:inset 0 0 0 1px rgba(193,79,69,.18)}.talera-manage-backdrop{position:fixed;inset:0;z-index:140;background:rgba(15,39,71,.22);backdrop-filter:blur(7px);-webkit-backdrop-filter:blur(7px);display:flex;align-items:flex-end;justify-content:center;padding:12px 10px max(12px,env(safe-area-inset-bottom))}.talera-manage-sheet{width:min(100%,560px);max-height:min(84dvh,730px);overflow:hidden;border-radius:26px;background:#fffdfa;color:#0F2747;box-shadow:0 24px 70px rgba(15,39,71,.26);display:flex;flex-direction:column}.talera-manage-head{display:grid;grid-template-columns:44px 1fr 44px;align-items:center;gap:8px;padding:12px 12px 8px;border-bottom:1px solid rgba(15,39,71,.07)}.talera-manage-head h2{margin:0;text-align:center;font:780 19px/1.1 system-ui}.talera-manage-close{width:44px;height:44px;border:0;border-radius:50%;background:rgba(220,234,246,.62);color:#0F2747;font:700 23px/1 system-ui}.talera-manage-body{padding:12px;overflow:auto;-webkit-overflow-scrolling:touch}.talera-manage-intro{margin:0 0 12px;color:#647181;font:520 13px/1.4 system-ui}.talera-manage-photo-list{display:grid;gap:10px}.talera-manage-photo{display:grid;grid-template-columns:92px minmax(0,1fr);gap:12px;align-items:center;padding:9px;border-radius:18px;background:#f5f4f1;box-shadow:inset 0 0 0 1px rgba(15,39,71,.07);transition:opacity .18s ease,transform .18s ease}.talera-manage-photo.is-removing{opacity:.18;transform:translateX(-18px);pointer-events:none}.talera-manage-photo img{width:92px;height:92px;border-radius:13px;display:block;object-fit:cover;background:#e8e5df}.talera-manage-photo-copy{min-width:0;display:grid;gap:7px}.talera-manage-photo-label{font:720 12px/1.2 system-ui;color:#526071}.talera-manage-photo-remove{min-height:48px;border:0;border-radius:14px;color:#8A2F2A;background:#fff;box-shadow:inset 0 0 0 1px rgba(193,79,69,.18);font:760 13px/1 system-ui}.talera-manage-empty{padding:18px 8px;text-align:center;color:#647181;font:560 13px/1.4 system-ui}.talera-delete-card{padding:10px 4px 4px;text-align:center}.talera-delete-card h3{margin:4px 0 8px;font:790 24px/1.08 system-ui}.talera-delete-card p{margin:0 auto;max-width:38ch;color:#647181;font:520 14px/1.42 system-ui}.talera-delete-now{width:100%;min-height:54px;margin-top:18px;border:0;border-radius:17px;background:#8A2F2A;color:#fff;font:770 15px/1 system-ui}.talera-manage-error{margin-top:10px;color:#8A2F2A;font:650 12px/1.35 system-ui}.talera-manage-toast{position:fixed;z-index:180;left:50%;bottom:max(22px,calc(env(safe-area-inset-bottom) + 14px));transform:translateX(-50%);width:min(430px,calc(100% - 28px));min-height:62px;padding:10px 12px 10px 16px;border-radius:19px;background:rgba(15,39,71,.96);color:white;box-shadow:0 15px 38px rgba(6,18,30,.30);display:flex;align-items:center;justify-content:space-between;gap:12px;font:690 13px/1.3 system-ui}.talera-manage-undo{min-height:42px;padding:0 14px;border:0;border-radius:14px;background:white;color:#0F2747;font:780 12px/1 system-ui;flex:0 0 auto}.talera-manage-toast.is-error{background:#8A2F2A}.talera-manage-toast.is-error .talera-manage-undo{display:none}@media(max-width:600px){.talera-story-manage-bar{gap:6px}.talera-story-manage-button{min-height:46px;padding:0 9px;font-size:12px}.talera-manage-sheet{max-height:88dvh}.talera-manage-photo{grid-template-columns:86px minmax(0,1fr)}.talera-manage-photo img{width:86px;height:86px}}';
